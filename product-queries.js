...
db.productlist.find({$or:[{"product_price":{$lte:400}},{"product_price":{$gte:600}}]})
...
db.productlist.find({},{_id:0,product_name:1,product_material:1})
...
db.productlist.find({product_material:{$regex:"Soft"}})
